...

{
    ...
    public function find_article($sql)
    {
     ...
     SELECT articles.id_article, articles.titre_article, articles.presentation_article, articles.prix_article, articles.image_article, `cat2`.`nom_categorie` AS 'cat parent', 'categorie' AS 'type'
            FROM articles
...
SELECT `art1`.id_article, `art1`.titre_article, `art1`.presentation_article, `art1`.prix_article, `art1`.image_article, `cat2`.`nom_categorie` AS 'cat parent', 'article' AS 'type'
...
SELECT articles.id_article, articles.titre_article, articles.presentation_article, articles.prix_article, articles.image_article, `cat2`.`nom_categorie` AS 'cat parent', 'tag' AS 'type'
            FROM articles
